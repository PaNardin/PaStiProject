...
Scrabble_score = {
    ...
    # Utilisation J V W K Y Q du dico anglais
    ...
    # Ajout K
    'Roumanie' : {"I":1, "A":1, "E":1, "T":1, "N":1, "R":1, "S":1, "C":1, "L":1, "O":1, "U":1,
    "P":2,
    "D":3,
    "M":4, "F":4, "V":4, 
    "G":6,
    ...
    # Ajout W
    'Slovaquie' : {"A":1, "O":1, "E":1, "I":1, "N":1, "R":1, "S":1, "T":1, "V":1,
    "M":2, "D":2, "K":2, "L":2, "P":2,
    "J":3, "U":3,
    "B":4, "C":4, "H":4, "Y":4, "Z":4,
    "F":8, "G":8,
        ...
        for filename in os.listdir('PASTI'):
            ...
            with open("PASTI/"+filename, 'rb') as csvfile:
                ...
                for name in spamreader:
                    ...
                    score = 0
                    if (len(name_str) != 0):
                        for letter in range(len(name_str)):

                            if name_str[letter].upper() in Scrabble_score[country]:
                                score += Scrabble_score[country][name_str[letter].upper()]
                            else:

                                print("ERROR:"+name_str[letter].upper()+" "+country)
                        result[name_str.upper()] = float(score)/len(name_str)
...
# case = raw_input('Select the case: surname or firstname or totalname: ')
case = "totalname"
